    ...
    <div className="dash-app">
      ...
      <aside className="dash-sidebar">
        ...
        <nav className="dash-nav">
          {NAV.map(n => (
            <a key={n.href}
          {(member?.fraction === 'Ishi No Fraction' || member?.frat_name === 'Big Brother Substance') && <a href="/dashboard/dues-report" className="dash-nav-item"><span>Dues Report</span></a>} href={n.href} className={`dash-nav-item ${n.href === '/dashboard' ? 'active' : ''}`}>
